...
{
    UIImage * userImage = [YDImage imagesFromCustomBundle:imgString];
    ...
    UIImage * userCleanBtnImage = [YDImage imagesFromCustomBundle:@"YD_clean"];
...
- (void)textFieldDidBeginEditing:(UITextField *)textField
{
    ...
    if (textField == self.textField)
    {
        ...
        self.titleImageView.image = [YDImage imagesFromCustomBundle:edited];
...
- (void)textFieldDidEndEditing:(UITextField *)textField
{
    if (textField.text.length == 0 && textField == self.textField)
    {
        ...
        self.titleImageView.image = [YDImage imagesFromCustomBundle:self.titleImageStr];
