...
@interface YDIAPHelper() <SKProductsRequestDelegate, SKPaymentTransactionObserver>
{
    SKProduct *myProduct;
}
...
+ (instancetype)iapHelper
{
    ...
    static YDIAPHelper *iapHelper = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        iapHelper = [YDIAPHelper new];
    });
