...
#import "GYIAPHelper.h"

@interface GYIAPHelper() <SKProductsRequestDelegate, SKPaymentTransactionObserver>
{
    SKProduct *myProduct;
}
...
+ (instancetype)iapHelper
{
    ...
    static GYIAPHelper *iapHelper = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        iapHelper = [GYIAPHelper new];
    });
